...
<svg
class="flex-shrink-0 w-8 h-8 text-green-500 dark:text-green-400 hover:cursor-pointer border-2 border-transparent rounded-md hover:border-gray-200"
fill="currentColor"
viewBox="0 0 20 20"
...
export const getDeleteIcon = (id) => `<svg
class="todo-delete-icon flex-shrink-0 w-6 h-6 text-orange-500 hover:cursor-pointer border-2 border-transparent rounded-md hover:border-gray-200"
data-task-id=${id}
fill="none"
stroke="currentColor"
stroke-width="1.5"
